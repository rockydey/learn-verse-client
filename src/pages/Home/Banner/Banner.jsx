      ...
      <div
        ...
        <div className='max-w-screen-xl mx-auto flex flex-col gap-8 md:gap-0 md:flex-row items-center justify-between py-16 px-2 md:px-4 lg:px-0'>
          <div className='md:w-1/2 space-y-8'>
            <h1 className='text-4xl lg:text-5xl dark:text-color4 text-color3 font-bold font-merriweather'>
            ...
            <p className='lg:w-4/5 text-base font-medium dark:text-color9 text-color6'>
